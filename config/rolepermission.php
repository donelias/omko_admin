...
$config = [
    ...
    'admin_appointment_schedules'   => array('read', 'update', 'delete'),
    ...
    'ad-banners'                    => array('create', 'read', 'update','delete'),
    'assign_package'                => array('read', 'update'),
    'watermark_settings'            => array('read', 'update'),
    'gemini_settings'               => array('read', 'update'),
    'payment_gateway_settings'      => array('read', 'update'),
    'demo_data'                     => array('read', 'update'),
];
return $config;
