...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (! has_permissions('create', 'users_accounts')) {
            ...
            return redirect()->back()->with('success', trans('User Insert Successfully'));
        }
    }
    ...
    public function update(Request $request)
    {
        ...
        if (! has_permissions('update', 'users_accounts')) {
            ...
            return redirect()->back()->with('success', trans('User Update Successfully'));
        }
    }
    ...
    public function userList(Request $request)
    {
        ...
        foreach ($res as $row) {
            ...
            $operate = '<a  id="'.$row->id.'" data-permission="'.$permission.'" data-id="'.$row->id.'"class="btn icon btn-primary btn-sm rounded-pill editdata m-1"  data-bs-toggle="modal" data-bs-target="#editUsereditModal1"  title="Edit"><i class="fa fa-edit"></i></a>';
            $operate .= '<a  id="'.$row->id.'" data-bs-toggle="modal"  class="btn icon btn-primary btn-sm rounded-pill m-1" data-bs-target="#resetpasswordmodel" onclick="setpasswordValue(this.id);"><i class="bi bi-key text-dark-50"></i></a>';
    ...
    public function resetpassword(Request $request)
    {
        if (! has_permissions('update', 'users_accounts')) {
            ...
            return redirect()->back()->with('success', trans('Password Reset Successfully'));
        }
    }
    ...
    public function destroy_contact_request($id)
    {
        ...
        if ($contactrequest->delete()) {
            ...
            ResponseService::successRedirectResponse(trans('Contact Request Deleted Successfully'));
        } else {
