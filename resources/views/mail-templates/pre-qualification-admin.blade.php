<h2>[Admin] Nueva Precalificación</h2>
<p>Se ha registrado una nueva solicitud de precalificación en el sistema.</p>
...
<table style="border-collapse:collapse;width:100%;max-width:600px;">
    ...
    <tr><td style="padding:8px;border:1px solid #ddd;font-weight:bold;">Ingreso Mensual</td><td style="padding:8px;border:1px solid #ddd;">{{ $currency }} {{ $monthly_income }}</td></tr>
    <tr><td style="padding:8px;border:1px solid #ddd;font-weight:bold;">Estado</td><td style="padding:8px;border:1px solid #ddd;">{{ $status }}</td></tr>
...
<p>Ingresa al panel de administración para revisar los documentos y dar seguimiento.</p>
