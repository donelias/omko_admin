        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row " id="toolbar">
                    ...
                    {{-- Filter Owner --}}
                    <div class="col-xl-3 mt-2">
                        <select id="project-owner-filter" class="form-select form-control-sm">
                            <option value="">{{ __('Select Project Owner') }} </option>
                        ...
                        <table class="table table-striped"
                            ...
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col" data-field="raw_document_action" data-align="center" data-sortable="false" data-events="actionEvents"> {{ __('Documents/Images') }}</th>
