...
@section('step')
    ...
    <form method="post" action="{{ route('install.purchase-code.post') }}">
        @csrf
        <div class="mb-3">
            <label for="purchase_code" class="block font-medium leading-5 text-gray-700 pb-2">Purchase Code <span class="text-gray-400">(opcional para desarrollo)</span></label>
            <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                   id="purchase_code" type="text" name="purchase_code" value="omko-dev-bypass" placeholder="Dejar vacío para desarrollo">
        </div>
