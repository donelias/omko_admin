    ...
    <section class="section">
        <div class="card add-category mt-3">
            <div class="card-header">
                <div class="divider">
                    <div class="divider-text"><h4>{{ __('Add Bank') }}</h4></div>
                </div>
            </div>
            <div class="card-content">
                <div class="card-body">
                    {!! Form::open(['url' => route('banks.store'), 'data-parsley-validate', 'class' => 'create-form']) !!}
                    <div class="row">
                        <div class="col-md-6 form-group mandatory">
                            {{ Form::label('name', __('Bank Name'), ['class' => 'form-label']) }}
                            {{ Form::text('name', '', ['class' => 'form-control', 'placeholder' => __('Enter Bank Name'), 'data-parsley-required' => 'true']) }}
                        </div>
                        <div class="col-md-3 form-group">
                            {{ Form::label('interest_rate', __('Interest Rate (%)'), ['class' => 'form-label']) }}
                            {{ Form::number('interest_rate', '', ['class' => 'form-control', 'placeholder' => __('e.g. 10.50'), 'step' => '0.01', 'min' => '0', 'max' => '99.99']) }}
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <table class="table table-striped" id="table_list" data-toggle="table"
                            data-url="{{ route('banks.show', 1) }}" data-click-to-select="true" data-responsive="true"
                            ...
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    @endif
                                    @if (has_permissions('update', 'bank') || has_permissions('delete', 'bank'))
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="editModalLabel">{{ __('Edit Bank') }}</h6>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal edit-form" action="{{ url('banks') }}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" id="edit-id" name="edit_id">
                        <div class="row">
                            <div class="col-md-6 form-group mandatory">
                                {{ Form::label('edit_name', __('Bank Name'), ['class' => 'form-label']) }}
