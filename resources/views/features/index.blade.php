    ...
    <section class="section">
        <div class="row">
            <div class="col-6">
                <div class="card">
                    <div class="card-header">
                        <h4>{{ __('User Features') }}</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <table class="table table-striped"
                                    id="table_list_user" data-toggle="table" data-url="{{ route('package-features.show',1) }}?user_type=user"
                                    ...
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            @endif
                                            <th scope="col" data-field="operate" data-sortable="false" data-align="center" data-width="5%"> {{ __('Action') }}</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-header">
                        <h4>{{ __('Agent Features') }}</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <table class="table table-striped"
                                    id="table_list_agent" data-toggle="table" data-url="{{ route('package-features.show',1) }}?user_type=agent"
                                    data-click-to-select="true" data-side-pagination="server" data-pagination="true"
                                    data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true"
                                    data-search-align="right" data-show-columns="true"
                                    data-show-refresh="true" data-trim-on-search="false" data-responsive="true"
                                    data-sort-name="id" data-sort-order="asc" data-pagination-successively-size="3"
                                    data-query-params="queryParamsAgent">
                                    <thead class="thead-dark">
                                        <tr>
                                            <th scope="col" data-field="id" data-sortable="true"> {{ __('ID') }}</th>
                                            <th scope="col" data-field="name" data-sortable="true"> {{ __('Name') }} </th>
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result.error == false) {
                        ...
                        $('#table_list_agent').bootstrapTable('refresh');
                    } else {
                        Toastify({
                            text: result.message,
                            duration: 6000,
